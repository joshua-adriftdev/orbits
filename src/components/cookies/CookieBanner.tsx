...
const CookieBanner: React.FC = ({}) => {
    ...
    return (
        <>
        {visible && (
            <section className="fixed max-w-md p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 left-12 bottom-16 dark:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl">
                <div className="flex items-center gap-x-4">
                    <span className="inline-flex p-2 text-green-500 rounded-lg shrink-0 dark:bg-gray-800 bg-green-100/80">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">By using this website, you agree to the use of cookies. <a href={location == "/cookies" ? "#" : "/cookies"} target={location == "/cookies" ? "" : "_blank"} rel="noopener noreferrer" className="text-green-500 hover:underline">Read cookies policy</a>. </p>
                </div>
            </section>)
        }
        </>
